...
export default function PlanSummary({ plan, filters, onBack, onEdit, onSave, onViewRestaurant }: PlanSummaryProps) {
  ...
  const shareLink = async () => {
    ...
    try {
      if (navigator.share) {
        await navigator.share({ title: 'My DineAhead Meal Plan', url });
      } else {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-100 via-rose-50 to-purple-100 p-4 md:p-6">
            ...
            <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-2xl animate-scale-in" 
              ...
              <div className="flex gap-3">
                ...
                <button 
                  ...
                  className="flex-1 py-3 bg-gradient-to-r from-orange-500 to-rose-500 text-white rounded-xl font-medium"
                >
                  Save
                </button>
              </div>
