...
export default function FiltersStep({ filters, setFilters, onNext, onBack }: FiltersStepProps) {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-orange-100 via-rose-50 to-purple-100 p-6">
      {/* Background blobs */}
      ...
      <div className="max-w-2xl mx-auto relative">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg mb-6 animate-fade-in-up delay-100">
          ...
          <div className="text-center mb-4">
            <span className="text-5xl font-bold bg-linear-to-r from-orange-500 to-rose-500 bg-clip-text text-transparent">
              ${filters.budget}
            </span>
        ...
        {/* Summary */}
        <div className="bg-linear-to-r from-orange-50 to-rose-50 rounded-2xl p-4 mb-6 animate-fade-in-up delay-300">
        ...
        <button 
          ...
          className="w-full bg-linear-to-r from-orange-500 to-rose-500 text-white py-4 rounded-xl 
